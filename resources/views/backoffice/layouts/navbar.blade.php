<!-- Navbar -->
<nav class="main-header navbar navbar-expand navbar-dark ireng-admin-navbar">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
        <li class="nav-item">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a target="_blank" rel="noopener noreferrer" href="{{ URL::to('/') }}" class="nav-link far fa-hand-point-right"> Go To Website</a>
        </li>
        {{-- <li class="nav-item d-none d-sm-inline-block">
