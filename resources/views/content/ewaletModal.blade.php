<!-- Modal -->
<div class="modal fade" id="modalEwallet{{ $e->id }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel{{ $e->id }}"
    aria-hidden="true">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-12 content-form">
                        ...
                        <form id="depositForm" class="needs-validation" action="{{ URL::to('account/deposit') }}"
                                        ...
                                        <div class="col-md-9 col-xs-8">
                                            <div class=" d-flex flex-wrap">
                                                <input type="text" id="min_in_bni"
                                                    ...
                                                    placeholder="Minimal Rp {{ number_format($setting->minimal_depo, 0, ',', '.') }}" name="nominal"
                                                    min="50000" required>
                                            </div>
                                        </div>
                                    </div>
