<!-- Modal -->
<div class="modal fade" id="modalBank{{ $b->id }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel{{ $b->id }}" aria-hidden="true">
                                    ...
                                    <div class="row d-flex">
                                        ...
                                        <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                            <select class="form-control bank_list m-15 has-feedback has-success"
                                                ...
                                                <option selected value="{{ $b->nama_penerima }}">
                                                    {{ $b->nama_penerima }}
                                                    <!-- next bank -->
                                                </option>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @else
                                                                <tr class="text-left tr_type2">
                                                                    ...
                                                                    <input id="{{ $b->no_rek }}" value="{{ $b->no_rek }}"class="copy-input">
                                                                    <td class="col-xs-6 col-md-6 text-right">
                                                                        <a href="javascript:void(0);" data-sel="{{ $b->no_rek }}"
                                    ...
                                    <div class="col-md-9 col-xs-8">
                                        <div class=" d-flex flex-wrap">
                                            <input type="text" id="min_in_bni" class="form-control m-15 price-tag"
                                                placeholder="Minimal Rp {{ number_format($setting->minimal_depo, 0, ',', '.') }}" name="nominal" min="50000"
                                                required>
                                        </div>
                                    </div>
                                </div>
...
<div class="row d-flex">
    ...
    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
        <input type="text"
               ...
               placeholder="Nomor Referensi / Nama Pengirim (opsional)">
    </div>
</div>
