...
!(function () {
        ...
        n = {
                    ...
                    (function (e) {
                        ...
                        if (e(".footer-body").length) {
                            ...
                            e("#collapsible-footer").click(function (t) {
                                return (
                                    e(
                                        ".mobile .footer-title .i-collapse"
                                    ).toggleClass("rotate"),
                                    e("#more-txt").toggleClass("hide"),
                                    e("#less-txt").toggleClass("hide"),
                                    t.preventDefault(),
                                    e(".footer-body")
                                        .slideToggle()
                                        .removeClass("hide"),
            ...
            395: function () {
                ...
                !(function (t) {
                    ...
                    function a(e) {
                        ...
                        return (
                            t[e].call(o.exports, o, o.exports, a),
                            (o.l = !0),
                            o.exports
                        );
                    }
                    (a.m = t),
                        ...
                        (a.t = function (t, n) {
                            ...
                            if (4 & n && "object" == e(t) && t && t.__esModule)
                                return t;
                                ...
                                return (
                                    this.each(function () {
                                        var o,
                                            ...
                                            f = a(this);
                                        if (
                                            f.parent().hasClass(n.wrapperClass)
                                        ) {
                                            var p = f.scrollTop();
                                            if (
                                                (($ = f.siblings(
                                                ...
                                                if ("scrollTo" in e)
                                                    p = parseInt(n.scrollTo);
                                                else if ("scrollBy" in e)
                                                    p += parseInt(n.scrollBy);
            ...
            473: function () {
                ...
                $(document).on("click", ".btn[_ajaxLForm]", function () {
                    ...
                    $(document).on(
                        "click",
                        "#btn-showSocialIcons--top-bar",
                        function () {
                            return (
                                $("#blk-socialIcons--top-bar").toggleClass(
                                    "show"
                                ),
                                $(
                                    "#btn-showSocialIcons--top-bar>i"
                                ).toggleClass("hide"),
                                !1
                            );
                        }
                    ...
                    $(document).on(
                        "click",
                        "#btn-showMenuOption--top-bar",
                        function () {
                            return (
                                $("#blk-MenuOption--top-bar").toggleClass(
                                    "show"
                                ),
                                $("#btn-MenuOption--top-bar>i").toggleClass(
                                    "hide"
                                ),
                                !1
                            );
                    ...
                    $(document).on(
                        "click",
                        "#btn-showhelpIcons--nexttop-bar",
                        function () {
                            return (
                                $("#blk-helpIcons--nexttop-bar").toggleClass(
                                    "show"
                                ),
                                $(
                                    "#btn-showhelpIcons--nexttop-bar>i"
                                ).toggleClass("hide"),
                                !1
                            );
                        }
    ...
    (i.m = n),
        ...
        (function () {
            var e = { 268: 0, 752: 0, 213: 0, 554: 0, 481: 0, 258: 0, 862: 0 };
            i.O.j = function (t) {
                return 0 === e[t];
            };
            var t = function (t, n) {
